...
export function HeaderSearch() {
  ...
  return (
    <div className="relative ">
      <div className={cn(
        "flex items-center transition-all duration-300 ease-in-out rounded-full border overflow-hidden relative z-50",
        isSearchOpen 
          ? "w-full max-w-[300px] bg-black border-white/20 px-2" 
